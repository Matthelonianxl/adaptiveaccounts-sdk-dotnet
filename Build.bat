...
%DEVENV% PayPalAdaptiveAccountsSDK\PayPalAdaptiveAccountsSDK.sln /clean Release
%DEVENV% PayPalAdaptiveAccountsSDK\PayPalAdaptiveAccountsSDK.sln /build Release
GOTO :END
