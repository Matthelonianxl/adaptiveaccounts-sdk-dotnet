This ASP.NET C# Web Application contains PayPal Adaptive Accounts API based Samples. 
...
Enter Arguments: 
install PayPal_AdaptiveAccounts_SDK -excludeversion -outputDirectory .\Packages
...
The 'PayPal_AdaptiveAccounts_SDK' Package including the dependencies will be downloaded to the 'Packages' folder root directory of the Solution (.sln) file.
...
On Manage NuGet Packages, search for 'PayPal_AdaptiveAccounts_SDK' to get the details