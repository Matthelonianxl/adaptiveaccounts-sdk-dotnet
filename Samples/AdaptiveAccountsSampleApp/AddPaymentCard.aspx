<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AddPaymentCard.aspx.cs"
    Inherits="AdaptiveAccountsSampleApp.AddPaymentCard" %>
    ...
    <div id="wrapper">
        ...
        <form method="post" action="AdaptiveAccountsHandler.ashx" runat="server">
            <div id="request_form">
                ...
                <table class="params">
                    <tr>
                        ...
                        <th>
                            Card type</th>
                        <th>
                            CardOwner DateOfBirth</th>
                        <th>
                            Card verification number (CVV2)</th>
                        <th>
                            Issue number</th>
                    </tr>
                    <tr>
                ...
                <div class="params">
                    <div class="param_name">
                        ConfirmationType * (ConfirmationType NONE requires advanced permission levels. You
                        must pass the createAccount key.)</div>
                    <div class="param_value">
