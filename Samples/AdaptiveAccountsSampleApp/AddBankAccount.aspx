<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AddBankAccount.aspx.cs"
    Inherits="AdaptiveAccountsSampleApp.AddBankAccount" %>
            ...
            <div id="request_form">
                ...
                <div class="params">
                    <div class="param_name">
                        Create Account Key ( <a href='CreateAccount.aspx'>Get CreateAccountKey</a>)
                    </div>
                ...
                <div class="params">
                    <div class="param_name">
                        International Bank Account Number (IBAN)</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        CLABE (Bank information for countries like Mexico)</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        BSB Number (Bank State Branch number)</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        Tax id type of CNPJ or CPF (Brazil only)</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        Account holder date of birth</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        Confirmation type * (ConfirmationType NONE requires advanced permission levels.
                        You must pass the createAccount key.)</div>
                    <div class="param_value">
                ...
                <div class="section_header">
                    Web options (For Confirmation Type WEB only)</div>
                <table class="params">
                    <tr>
                        <th class="param_name">
                            Return URL</th>
                        <th class="param_name">
                            Return URL description</th>
                        <th class="param_name">
                            Cancel URL</th>
                        <th class="param_name">
                            Cancel URL description</th>
                    </tr>
                    <tr>
