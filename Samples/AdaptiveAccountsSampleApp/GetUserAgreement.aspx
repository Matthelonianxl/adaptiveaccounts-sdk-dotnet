<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GetUserAgreement.aspx.cs"
    Inherits="AdaptiveAccountsSampleApp.GetUserAgreement" %>
        ...
        <form method="post" action="adaptiveaccountshandler.ashx" runat="server">
            <div id="request_form">
                <div class="note">
                    ...
                    so will result in an error.</div>
                <div class="params">
