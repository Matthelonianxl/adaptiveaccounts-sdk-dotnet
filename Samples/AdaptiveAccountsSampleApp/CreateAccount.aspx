...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<div id="apidetails">The CreateAccount API operation enables you to create a 
			PayPal account on behalf of a third party.</div>
		</div>
		<form method="post" action="adaptiveaccountshandler.ashx" runat="server">
			<div id="request_form">
				...
				<div class="params">					
					<div class="param_name">Registration type (Mobile: Returns a key to complete the registration. Web: Returns a URL to complete the registration)</div>
					<div class="param_value">
				...
				<div class="params">					
					<div class="param_name">Tax Id (tax id, ssn, itin, pan, cpf, acn, abn, etc)</div>
					<div class="param_value">
				...
				<div class="section_header">Business info (for business accounts only)</div>
				<div class="params">					
				...
				<table class="params">
					...
					<tr>
						<td><input type="text" name="businessAddressLine1" value="1968 Ape Way" /></td>
						<td><input type="text" name="businessAddressLine2" value="" /></td>
						<td><input type="text" name="businessAddressCity" value="Austin" /></td>
						<td><input type="text" name="businessAddressState" value="TX" /></td>
						<td><input type="text" name="businessAddressPostalCode" value="78750" /></td>
						<td><input type="text" name="businessAddressCountryCode" value="US" /></td>			
					</tr>
				</table>
				<div class="params">					
				...
				<div class="params">					
					<div class="param_name">Category describing the business. (Refer to the business’ Association Merchant Category Code documentation)</div>
					<div class="param_value">
						<input type="text" name="category" value="" />
					</div>
				</div>
				<div class="params">					
					<div class="param_name">Sub-category describing the business. (Refer to the business’ Association Merchant Category Code documentation)</div>
					<div class="param_value">
						<input type="text" name="subCategory" value="" />
					</div>
				</div>
				<div class="params">					
					<div class="param_name">Merchant category code. (Category code for the business. state in which the business was established)</div>
					<div class="param_value">
						<input type="text" name="merchantCategoryCode" value="" />
					</div>
				</div>
				<div class="params">					
					<div class="param_name">Doing business as. (The business name being used if it is not the actual name of the  business)</div>
					<div class="param_value">
				...
				<div class="params">					
					<div class="param_name">Business subtype (required only for Business Type GOVERNMENT and ASSOCIATION_GOVERNMENT)</div>
					<div class="param_value">
				...
				<table class="params">
					...
					<tr>
						<td><input type="text" name="placeOfBusinessLine1" value="1968 Ape Way" /></td>
						<td><input type="text" name="placeOfBusinessLine2" value="" /></td>
						<td><input type="text" name="placeOfBusinessCity" value="Austin" /></td>
						<td><input type="text" name="placeOfBusinessState" value="TX" /></td>
						<td><input type="text" name="placeOfBusinessPostalCode" value="78750" /></td>
						<td><input type="text" name="placeOfBusinessCountryCode" value="US" /></td>			
					</tr>
				</table>
				...
				<table class="params">
					...
					<tr>
						<td><input type="text" name="registeredOfficeLine1" value="1968 Ape Way" /></td>
						<td><input type="text" name="registeredOfficeLine2" value="" /></td>
						<td><input type="text" name="registeredOfficeCity" value="Austin" /></td>
						<td><input type="text" name="registeredOfficeState" value="TX" /></td>
						<td><input type="text" name="registeredOfficePostalCode" value="78750" /></td>
						<td><input type="text" name="registeredOfficeCountryCode" value="US" /></td>			
					</tr>
				</table>				
				<div class="params">					
				...
				<table class="params">
					...
					<tr>
						<td><input type="text" name="stakeholderLine1" value="1968 Ape Way" /></td>
						...
						<td><input type="text" name="stakeholderPostalCode" value="78750" /></td>
						<td><input type="text" name="stakeholderCountryCode" value="US" /></td>			
					</tr>
				</table>
				<div class="params">					
					<div class="param_name">Date of birth</div>
