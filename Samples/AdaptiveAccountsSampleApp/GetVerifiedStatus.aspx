<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GetVerifiedStatus.aspx.cs"
    Inherits="AdaptiveAccountsSampleApp.GetVerifiedStatus" %>
...
<body>
    <div id="wrapper">
        <div id="header">
            <h3>
                Get Verified Status</h3>
            <div id="apidetails">
                The GetVerifiedStatus method lets you check if a PayPal account status is verified.
                A PayPal account gains verified status under a variety of circumstances, such as
            ...
            <div id="request_form">
                <div class="params">
                    <div class="param_name">
                        Email Address of the account holder *</div>
                ...
                <div class="params">
                    ...
                    <span class="note">NOTE: To use Match criteria NONE you must request and be granted
                        advanced permission levels.</span>
                </div>
                <div class="params">
                    <div class="param_name">
                        First Name (Required if matchCriteria is NAME)</div>
                    <div class="param_value">
                ...
                <div class="params">
                    <div class="param_name">
                        Last Name (Required if matchCriteria is NAME)</div>
                    <div class="param_value">
