The PayPal Adaptive Accounts SDK C#.NET Class Library project contains the PayPal Adaptive Accounts Stubs.
...
The PayPal Adaptive Accounts SDK
--------------------------------
*	The PayPal Adaptive Accounts SDK lets you build applications that create PayPal accounts and handle account management.
